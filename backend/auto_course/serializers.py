...
class RequestSerializer(serializers.ModelSerializer):
    ...
    teacher_id = serializers.CharField(source="teacher.username")
    class Meta:
        model = Request
        fields = ('id', 'teacher_id', 'teacher', 'topic', 'content', 'status', )
...
class TimetableSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'teacher_username', 'teacher', 'course_id', 'course', 'room', 'time',)
